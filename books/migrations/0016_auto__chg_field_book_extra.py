...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.extra'
        db.alter_column('books_book', 'extra', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Book.extra'
        db.alter_column('books_book', 'extra', self.gf('django.db.models.fields.TextField')(default=''))
