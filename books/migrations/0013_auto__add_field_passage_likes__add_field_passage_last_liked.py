...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passage.likes'
        db.add_column('books_passage', 'likes',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Passage.last_liked'
        db.add_column('books_passage', 'last_liked',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passage.likes'
        db.delete_column('books_passage', 'likes')

        # Deleting field 'Passage.last_liked'
        db.delete_column('books_passage', 'last_liked')
